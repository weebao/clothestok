...
url = "https://levihsu-ootdiffusion.hf.space/queue/join?"
session_hash = "c07ams0oufv"

def upload_file(humanFile, clothesFile):
    uploadUrl = "https://yisol-idm-vton.hf.space/upload?upload_id=fg5337lne7i"
    humanPath = clothesPath = None 
...
def clothes_tryon(humanFile, clothesFile):
    ...
    payload = {
        "data": [
            {
                "path": humanPath, # "/tmp/gradio/0dc2e5ca0e97bcd0c46950316bda838a46167da4/meou.png", 
                "url": "https://yisol-idm-vton.hf.space/file=" + humanPath, # "https://levihsu-ootdiffusion.hf.space/file=/tmp/gradio/0dc2e5ca0e97bcd0c46950316bda838a46167da4/meou.png",
                "size": None,
                "mime_type": "image/png",
                "meta": {
                    "_type": "gradio.FileData"
            ...
            {
                "path": clothesPath, # "/tmp/gradio/17c62353c027a67af6f4c6e8dccce54fba3e1e43/048554_1.jpg"
                "url":  "https://yisol-idm-vton.hf.space/file=" + clothesPath, #"https://levihsu-ootdiffusion.hf.space/file=/tmp/gradio/17c62353c027a67af6f4c6e8dccce54fba3e1e43/048554_1.jpg",
                "size": None,
                "mime_type": None,
                "is_stream": False,
                "meta": {
