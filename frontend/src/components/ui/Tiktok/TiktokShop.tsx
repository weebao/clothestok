  ...
  return (
    <div className="w-full h-full py-24 px-4 overflow-y-scroll no-scrollbar">
      <div className="relative mb-2">
        ...
        />
        <button className="absolute bg-white text-black rounded-md top-[5px] right-[5px] px-2 font-bold">
          Search
        </button>
      </div>
      ...
      <div className="rounded-lg bg-accent text-white px-4 pt-2 pb-4 mb-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-neutral-50 aspect-square rounded-lg">
          </div>
          <div className="bg-neutral-50 aspect-square rounded-lg">
          </div>
          <div className="bg-neutral-50 aspect-square rounded-lg">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-neutral-50 aspect-square rounded-lg col-span-2 row-span-2">
        </div>
        <div className="bg-neutral-50 aspect-square rounded-lg">
        </div>
        <div className="bg-neutral-50 aspect-square rounded-lg">
